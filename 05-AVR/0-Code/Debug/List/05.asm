...
_0x0:
	.DB  0x61,0x72,0x73,0x68,0x69,0x61,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0090 // D4 - PORTA Bit 3
; 0000 0091 // D5 - PORTA Bit 4
; 0000 0092 // D6 - PORTA Bit 5
; 0000 0093 // D7 - PORTA Bit 6
...
_0x3:
; 0000 0098       {
; 0000 0099 lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009A lcd_puts("arshia");
	__POINTW2MN _0x6,0
	RCALL SUBOPT_0x0
