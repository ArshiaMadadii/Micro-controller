...
_0x0:
	.DB  0x54,0x68,0x65,0x6D,0x70,0x20,0x3D,0x20
...
_main:
; .FSTART _main
; 0000 0034 char th[20];
; 0000 0035 int themp;
; 0000 0036 int themp2;
...
; 0000 0096 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0097 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
...
_0x6:
; 0000 00B0       {
; 0000 00B1       themp=read_adc(0); // read_adc , baray khandan meghdar sensor
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00B2       themp2 = themp/2.054 ;
	CALL __CWD1
	CALL __CDF1
	MOVW R26,R30
	MOVW R24,R22
	...
	CALL __CFD1
	MOVW R18,R30
; 0000 00B3       sprintf(th, "Themp = %d " , themp2);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
