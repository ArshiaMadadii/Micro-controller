...
; 0000 00AD // Characters/line: 8
; 0000 00AE lcd_init(8);
	LDI  R26,LOW(8)
	CALL _lcd_init
; 0000 00AF 
; 0000 00B0 while (1)
_0x6:
; 0000 00B1       {
; 0000 00B2       volt = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00B3       volt2=volt/204.8;
	CALL SUBOPT_0x0
	MOVW R26,R30
	MOVW R24,R22
	__GETD1N 0x434CCCCD
